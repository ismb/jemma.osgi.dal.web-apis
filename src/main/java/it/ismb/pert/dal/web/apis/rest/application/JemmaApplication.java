...
/**
 * Class implementind Restlet Application, used to attache all used Resources to
 * restlet router
 * 
...
public class JemmaApplication extends Application {
	...
	public Restlet createInboundRoot() {
		...
		router.attach("/devices/{device_uid}/functions", FunctionsDeviceResource.class); // get
																							// device
																							// functions
		router.attach("/functions/{function_uid}", OperationInvokeResource.class); // invoke
																					// function
																					// method
